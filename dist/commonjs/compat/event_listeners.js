...
function getDocumentVisibilityRef(stopListening) {
    ...
    var hidden = (0, is_non_empty_string_1.default)(prefix) ? prefix + "Hidden" :
        "hidden";
    var visibilityChangeEvent = (0, is_non_empty_string_1.default)(prefix) ? prefix + "visibilitychange" :
        "visibilitychange";
...
function getPictureOnPictureStateRef(elt, stopListening) {
    ...
    var ref = new reference_1.default({ isEnabled: isPIPEnabled,
...
function getScreenResolutionRef(stopListening) {
    var _a, _b;
    var pixelRatio = global_scope_1.default.devicePixelRatio == null ||
        global_scope_1.default.devicePixelRatio === 0 ? 1 :
        global_scope_1.default.devicePixelRatio;
    var ref = new reference_1.default({ width: (_a = global_scope_1.default.screen) === null || _a === void 0 ? void 0 : _a.width,
        height: (_b = global_scope_1.default.screen) === null || _b === void 0 ? void 0 : _b.height, pixelRatio: pixelRatio }, stopListening);
...
function getElementResolutionRef(mediaElement, pipStatusRef, stopListening) {
    var pixelRatio = global_scope_1.default.devicePixelRatio == null ||
        global_scope_1.default.devicePixelRatio === 0 ? 1 :
        global_scope_1.default.devicePixelRatio;
    var ref = new reference_1.default({ width: mediaElement.clientWidth,
