...
function getLocalManifestPipelines(transportOptions) {
    ...
    var manifestPipeline = {
        ...
        parseManifest: function (manifestData) {
            ...
            var warnings = [];
            var manifest = new manifest_1.default(parsed, transportOptions, warnings);
            return { manifest: manifest, url: undefined, warnings: warnings };
        },
    };
    var segmentPipeline = { loadSegment: segment_loader_1.default,
        parseSegment: segment_parser_1.default };
    var textTrackPipeline = { loadSegment: segment_loader_1.default,
