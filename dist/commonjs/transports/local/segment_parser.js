...
function segmentParser(loadedSegment, context, initTimescale) {
    ...
    if (segment.isInit) {
        var timescale = containerType === "webm" ? (0, matroska_1.getTimeCodeScale)(chunkData, 0) :
    ...
    var chunkInfos = seemsToBeMP4 ? (0, get_isobmff_timing_infos_1.default)(chunkData, false, segment, initTimescale) :
