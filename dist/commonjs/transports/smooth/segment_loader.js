...
var generateSegmentLoader = function (_a) {
    ...
    return function (url, context, loaderOptions, cancelSignal, callbacks) {
        ...
        if (segment.isInit) {
            ...
            var codecPrivateData = smoothInitPrivateInfos.codecPrivateData, timescale = smoothInitPrivateInfos.timescale, height = smoothInitPrivateInfos.height, width = smoothInitPrivateInfos.width, _a = smoothInitPrivateInfos.protection, protection = _a === void 0 ? { keyId: undefined,
            ...
            return new Promise(function (res, rej) {
                ...
                var fallback = function () {
                    ...
                    hasFinished = true;
                    cancelSignal.deregister(abortCustomLoader);
                    regularSegmentLoader(url, context, callbacks, loaderOptions, cancelSignal, checkMediaSegmentIntegrity)
                        .then(res, rej);
                };
                ...
                var args = { isInit: context.segment.isInit,
                    timeout: loaderOptions.timeout, byteRanges: byteRanges, trackType: context.type, url: url };
