...
function createFTYPBox(majorBrand, brands) {
    var content = byte_parsing_1.concat.apply(void 0, __spreadArray([], __read([(0, string_parsing_1.strToUtf8)(majorBrand),
        [0, 0, 0, 1]].concat(brands.map(string_parsing_1.strToUtf8))), false));
...
function createAVCCBox(sps, pps, nalLen) {
    ...
    var h264Level = sps[3];
    return (0, isobmff_1.createBox)("avcC", (0, byte_parsing_1.concat)([
        1,
        h264Profile,
        ...
        (0x3F << 2 | nal),
        (0xE0 | 1),
    ], (0, byte_parsing_1.itobe2)(sps.length), sps, [1], (0, byte_parsing_1.itobe2)(pps.length), pps));
}
...
function createHDLRBox(type) {
    ...
    return (0, isobmff_1.createBox)("hdlr", (0, byte_parsing_1.concat)(8, (0, string_parsing_1.strToUtf8)(name), 12, (0, string_parsing_1.strToUtf8)(handlerName), 1 // handler name is C-style string (0 terminated)
    ));
}
...
function createMVHDBox(timescale, trackId) {
    ...
    [0, 1], 14, // default matrix
    [64, 0, 0, 0], 26, (0, byte_parsing_1.itobe2)(trackId + 1) // next trackId (=trackId + 1);
    ));
}
...
function createSAIOBox(mfhd, tfhd, tfdt, trun) {
    ...
    (0, byte_parsing_1.itobe4)(mfhd.length +
        tfhd.length +
        tfdt.length +
        trun.length +
        8 + 8 + 8 + 8)));
...
function createTKHDBox(width, height, trackId) {
    ...
    (0, byte_parsing_1.itobe2)(height), 2 // height (TODO handle fixed)
    ));
}
