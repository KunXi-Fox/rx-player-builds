...
function default_1(transportOptions) {
    ...
    var manifestLoader = (0, generate_manifest_loader_1.default)(manifestLoaderOptions, "text");
    ...
    var audioVideoPipeline = {
        ...
        parseSegment: function (loadedSegment, context, initTimescale) {
            ...
            var predictedSegments = nextSegments.length > 0 ? nextSegments :
                undefined;
            return { segmentType: "media", chunkData: chunkData, chunkInfos: chunkInfos, chunkOffset: 0,
                chunkSize: chunkData.length,
                protectionData: [], predictedSegments: predictedSegments, appendWindow: [undefined, undefined] };
        },
    };
    var textTrackPipeline = {
        ...
        parseSegment: function (loadedSegment, context, initTimescale) {
            ...
            if (isMP4) {
                ...
                _sdData = mdat === null ? "" :
                    (0, string_parsing_1.utf8ToStr)(mdat);
            }
            else { // not MP4
                segmentStart = segment.time;
                segmentEnd = segment.end;
            ...
            var predictedSegments = Array.isArray(nextSegments) &&
            ...
            return { segmentType: "media",
                chunkData: { type: _sdType,
                    data: _sdData,
                    start: segmentStart,
                    end: segmentEnd, language: language }, chunkSize: chunkSize, chunkInfos: chunkInfos, chunkOffset: chunkOffset, protectionData: [], predictedSegments: predictedSegments, appendWindow: [undefined, undefined] };
        },
    };
