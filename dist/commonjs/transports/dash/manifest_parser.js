...
function generateManifestParser(options) {
    ...
    return function manifestParser(manifestData, parserOptions, onWarnings, cancelSignal, scheduleRequest) {
        ...
        var unsafelyBaseOnPreviousManifest = parserOptions.unsafeMode ?
            ...
            null;
        var dashParserOpts = { unsafelyBaseOnPreviousManifest: unsafelyBaseOnPreviousManifest, url: url, referenceDateTime: referenceDateTime, externalClockOffset: externalClockOffset };
        ...
        function processMpdParserResponse(parserResponse) {
            if (parserResponse.type === "done") {
                ...
                var warnings = [];
                var manifest = new manifest_1.default(parserResponse.value.parsed, options, warnings);
...
function getManifestAsDocument(manifestSrc) {
    if (manifestSrc instanceof ArrayBuffer) {
        return new DOMParser()
            .parseFromString((0, string_parsing_1.utf8ToStr)(new Uint8Array(manifestSrc)), "text/xml");
    }
