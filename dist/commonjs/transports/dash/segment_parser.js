...
function generateAudioVideoSegmentParser(_a) {
    ...
    return function audioVideoSegmentParser(loadedSegment, context, initTimescale) {
        ...
        if (!segment.isInit) {
            var chunkInfos = seemsToBeMP4 ? (0, get_isobmff_timing_infos_1.default)(chunkData, isChunked, segment, initTimescale) :
            ...
            if (seemsToBeMP4) {
                ...
                if (parsedEMSGs !== undefined) {
                    ...
                    if (events !== undefined) {
                        ...
                        return { segmentType: "media", chunkData: chunkData, chunkSize: chunkData.length, chunkInfos: chunkInfos, chunkOffset: chunkOffset, appendWindow: appendWindow, inbandEvents: inbandEvents, protectionData: protectionData, needsManifestRefresh: needsManifestRefresh };
                    }
                }
            }
        ...
        if (containerType === "webm") {
            ...
            segmentList = (0, isobmff_1.getSegmentsFromSidx)(chunkData, Array.isArray(indexRange) ?
                indexRange[0] :
                0);
        ...
        var timescale = seemsToBeMP4 ? (0, isobmff_1.getMDHDTimescale)(chunkData) :
            containerType === "webm" ? (0, matroska_1.getTimeCodeScale)(chunkData, 0) :
                undefined;
        var parsedTimescale = (0, is_null_or_undefined_1.default)(timescale) ? undefined :
            timescale;
        return { segmentType: "init",
            initializationData: chunkData,
            initializationDataSize: chunkData.length, protectionData: protectionData, initTimescale: parsedTimescale,
