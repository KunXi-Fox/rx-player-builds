...
function getEventsOutOfEMSGs(parsedEMSGs, manifestPublishTime) {
    ...
    var _a = parsedEMSGs
        ...
        EMSGs: undefined }), manifestRefreshEventsFromEMSGs = _a.manifestRefreshEventsFromEMSGs, EMSGs = _a.EMSGs;
    var inbandEvents = EMSGs === null || EMSGs === void 0 ? void 0 : EMSGs.map(function (evt) { return ({ type: "emsg",
        value: evt }); });
    var needsManifestRefresh = (manifestPublishTime === undefined ||
        manifestRefreshEventsFromEMSGs === undefined) ?
        false :
