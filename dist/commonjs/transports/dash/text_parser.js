...
function parseISOBMFFEmbeddedTextTrack(data, isChunked, context, initTimescale, __priv_patchLastSegmentInSidx) {
    ...
    var chunkBytes = typeof data === "string" ? (0, string_parsing_1.strToUtf8)(data) :
        data instanceof Uint8Array ? data :
            new Uint8Array(data);
    if (isInit) {
        var segmentList = (0, isobmff_1.getSegmentsFromSidx)(chunkBytes, Array.isArray(indexRange) ? indexRange[0] :
            0);
 ...
 * @returns {Function}
 */
function generateTextTrackParser(_a) {
...
exports.default = generateTextTrackParser;
