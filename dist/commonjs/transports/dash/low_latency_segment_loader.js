...
var extract_complete_chunks_1 = require("./extract_complete_chunks");
/**
...
function lowLatencySegmentLoader(url, content, options, callbacks, cancelSignal) {
    ...
    var headers = segment.range !== undefined ? { Range: (0, byte_range_1.default)(segment.range) } :
        undefined;
    ...
    function onData(info) {
        ...
        var concatenated = partialChunk !== null ? (0, byte_parsing_1.concat)(partialChunk, chunk) :
            chunk;
        var res = (0, extract_complete_chunks_1.default)(concatenated);
    ...
    return (0, fetch_1.default)({ url: url, headers: headers, onData: onData, timeout: options.timeout, cancelSignal: cancelSignal })
