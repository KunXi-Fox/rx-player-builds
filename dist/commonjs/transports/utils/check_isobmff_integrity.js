...
function checkISOBMFFIntegrity(buffer, isInitSegment) {
    if (isInitSegment) {
        var ftypIndex = (0, find_complete_box_1.default)(buffer, 0x66747970 /* ftyp */);
        if (ftypIndex < 0) {
            throw new errors_1.OtherError("INTEGRITY_ERROR", "Incomplete `ftyp` box");
        }
        var moovIndex = (0, find_complete_box_1.default)(buffer, 0x6D6F6F76 /* moov */);
        if (moovIndex < 0) {
            throw new errors_1.OtherError("INTEGRITY_ERROR", "Incomplete `moov` box");
        }
    }
    else {
        var moofIndex = (0, find_complete_box_1.default)(buffer, 0x6D6F6F66 /* moof */);
        if (moofIndex < 0) {
            throw new errors_1.OtherError("INTEGRITY_ERROR", "Incomplete `moof` box");
        }
        var mdatIndex = (0, find_complete_box_1.default)(buffer, 0x6D646174 /* mdat */);
        if (mdatIndex < 0) {
