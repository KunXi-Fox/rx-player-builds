 ...
 * @returns {Promise}
 */
function disposeDecryptionResources(mediaElement) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    media_keys_infos_store_1.default.clearState(mediaElement);
                ...
                case 1:
                    ...
                    return [2 /*return*/, Promise.race([
                            currentState.emeImplementation.setMediaKeys(mediaElement, null)
                                .catch(function (err) {
                                log_1.default.error("DRM: Could not reset MediaKeys", err instanceof Error ? err : "Unknown Error");
                            }),
