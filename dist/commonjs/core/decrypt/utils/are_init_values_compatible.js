...
function _isAInB(a, b) {
    ...
    for (; bIdx < b.length; bIdx++) {
        ...
        var aData = firstAElt.data instanceof Uint8Array ? firstAElt.data :
            typeof firstAElt.data === "string" ? serializable_bytes_1.default.decode(firstAElt.data) :
                firstAElt.data.initData;
        var bData = bElt.data instanceof Uint8Array ? bElt.data :
            typeof bElt.data === "string" ? serializable_bytes_1.default.decode(bElt.data) :
                bElt.data.initData;
        ...
        for (aIdx = 1; aIdx < a.length; aIdx++) {
            ...
            for (bIdx += 1; bIdx < b.length; bIdx++) {
                ...
                var aNewData = aElt.data instanceof Uint8Array ? aElt.data :
                    typeof aElt.data === "string" ? serializable_bytes_1.default.decode(aElt.data) :
                        aElt.data.initData;
                var bNewData = bNewElt.data instanceof Uint8Array ? bNewElt.data :
                    typeof bNewElt.data === "string" ? serializable_bytes_1.default.decode(bNewElt.data) :
