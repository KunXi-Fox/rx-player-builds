...
var PersistentSessionsStore = /** @class */ (function () {
    ...
    PersistentSessionsStore.prototype.add = function (initData, keyIds, session) {
        ...
        if (keyIds === undefined) {
            ...
            this._entries.push({ version: 4, sessionId: sessionId, keyIds: keyIds.map(function (k) { return new serializable_bytes_1.default(k); }),
                values: storedValues,
                initDataType: initData.type });
        }
        this._save();
...
function prepareValuesForStore(initialValues) {
    return initialValues
        ...
        return ({ systemId: systemId, hash: hash, data: new serializable_bytes_1.default(data) });
    });
}
