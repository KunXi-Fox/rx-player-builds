...
var onKeyError = compat_1.events.onKeyError, onKeyMessage = compat_1.events.onKeyMessage, onKeyStatusesChange = compat_1.events.onKeyStatusesChange;
/**
...
function formatGetLicenseError(error) {
    if (error instanceof GetLicenseTimeoutError) {
        return new errors_1.EncryptedMediaError("KEY_LOAD_TIMEOUT", "The license server took too much time to " +
            "respond.");
    }
