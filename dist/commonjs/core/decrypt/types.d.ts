 ...
 */
import { IAdaptationMetadata, IManifestMetadata, IPeriodMetadata, IRepresentationMetadata } from "../../manifest";
...
export declare const enum MediaKeySessionLoadingType {
    /**
