 ...
 */
// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
function mockCompat(exportedFunctions) {
    var _a, _b, _c;
    if (exportedFunctions === void 0) { exportedFunctions = {}; }
    var ee = new MockedDecryptorEventEmitter();
    var onEncrypted = (_a = exportedFunctions.onEncrypted) !== null && _a !== void 0 ? _a : jest.fn(function (elt, fn, signal) {
    ...
    var mockRmksa = (_b = exportedFunctions.requestMediaKeySystemAccess) !== null && _b !== void 0 ? _b : jest.fn(requestMediaKeySystemAccessImpl);
    var mockSetMediaKeys = (_c = exportedFunctions.setMediaKeys) !== null && _c !== void 0 ? _c : jest.fn(function () { return Promise.resolve(); });
    ...
    jest.mock("../../../../compat", function () { return (__assign({ events: mockEvents, shouldRenewMediaKeySystemAccess: jest.fn(function () { return false; }), shouldWaitForEncryptedBeforeAttachment: jest.fn(function () { return false; }), canReuseMediaKeys: jest.fn(function () { return true; }) }, exportedFunctions)); });
    var emeImplementation = {
        onEncrypted: onEncrypted,
        requestMediaKeySystemAccess: mockRmksa,
        setMediaKeys: mockSetMediaKeys,
    };
    jest.mock("../../../../compat/eme", function () { return (__assign({ __esModule: true, default: emeImplementation, getInitData: mockGetInitData, generateKeyRequest: mockGenerateKeyRequest }, exportedFunctions)); });
    return { mockEvents: mockEvents, eventTriggers: {
