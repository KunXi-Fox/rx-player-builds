...
var TracksStore = /** @class */ (function (_super) {
    ...
    TracksStore.prototype.addTrackReference = function (bufferType, period, adaptationRef) {
        ...
        if (periodObj[bufferType].dispatcher !== null) {
            log_1.default.error("TS: Subject already added for ".concat(bufferType, " ") +
    ...
    TracksStore.prototype._setAudioOrTextTrack = function (_a) {
        var _b, _c;
        var bufferType = _a.bufferType, periodRef = _a.periodRef, trackId = _a.trackId, switchingMode = _a.switchingMode, reprsToLock = _a.reprsToLock, relativeResumingPosition = _a.relativeResumingPosition;
        ...
        var storedSettings = { adaptation: wantedAdaptation, switchingMode: switchingMode, lockedRepresentations: lockedRepresentations, relativeResumingPosition: relativeResumingPosition };
        typeInfo.storedSettings = storedSettings;
    ...
    TracksStore.prototype.setVideoTrack = function (payload) {
        ...
        var storedSettings = { adaptationBase: wantedAdaptation,
            ...
            adaptation: newAdaptation, relativeResumingPosition: relativeResumingPosition, lockedRepresentations: lockedRepresentationsRef };
        typeInfo.storedSettings = storedSettings;
        this.trigger("trackUpdate", { period: toExposedPeriod(period),
            trackType: "video",
            reason: "manual" });
    ...
    TracksStore.prototype.lockAudioRepresentations = function (periodObj, lockSettings) {
        ...
        storedSettings.lockedRepresentations.setValue({ representationIds: filtered, switchingMode: switchingMode });
    };
...
function generatePeriodInfo(period, inManifest, isTrickModeTrackEnabled, defaultAudioTrackSwitchingMode) {
    ...
    var forcedSubtitles = ((_a = period.adaptations.text) !== null && _a !== void 0 ? _a : [])
    ...
    if (forcedSubtitles.length > 0) {
        if (audioAdaptation !== null && audioAdaptation !== undefined) {
            var sameLanguage = (0, array_find_1.default)(forcedSubtitles, function (f) {
        ...
        if (textAdaptation === null) {
            textAdaptation = (_b = (0, array_find_1.default)(forcedSubtitles, function (f) { return f.normalizedLanguage === undefined; })) !== null && _b !== void 0 ? _b : null;
        }
    }
    ...
    return { period: period, inManifest: inManifest, isPeriodAdvertised: false,
        isRemoved: false,
