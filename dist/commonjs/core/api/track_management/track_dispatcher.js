...
var TrackDispatcher = /** @class */ (function (_super) {
    ...
    TrackDispatcher.prototype.updateTrack = function (newTrackInfo) {
        ...
        this._updateToken = false;
        this._adaptationRef.setValue({ adaptationId: adaptation.id, switchingMode: switchingMode, representations: reference, relativeResumingPosition: relativeResumingPosition });
    };
    /**
    ...
    TrackDispatcher.prototype._constructLockedRepresentationsReference = function (trackInfo) {
        ...
        function updateReferenceIfNeeded() {
            ...
            if (repSettings === null) { // unlocking
                ...
                var representations = trackInfo.adaptation.representations
                    .filter(function (r) { return (0, array_includes_1.default)(representationIds_1, r.id); });
                playableRepresentations = representations
                    .filter(function (r) { return r.isSupported === true && r.decipherable !== false; });
            ...
            var sortedReps = playableRepresentations.map(function (r) { return r.id; }).slice().sort();
