...
function createAudioTracks(audioTracks) {
    ...
    for (var i = 0; i < audioTracks.length; i++) {
        ...
        var track = { language: audioTrack.language, id: id, normalized: (0, languages_1.default)(audioTrack.language),
...
function createTextTracks(textTracks) {
    ...
    for (var i = 0; i < textTracks.length; i++) {
        ...
        var forced = textTrack.kind === "forced" ?
            true :
            undefined;
        var track = { language: textTrack.language, forced: forced, label: textTrack.label, id: id, normalized: (0, languages_1.default)(textTrack.language),
...
var MediaElementTracksStore = /** @class */ (function (_super) {
    ...
    MediaElementTracksStore.prototype._enableAudioTrackFromIndex = function (index) {
        (0, compat_1.enableAudioTrack)(this._audioTracks.map(function (_a) {
