...
var tracks_store_1 = require("./track_management/tracks_store");
var utils_1 = require("./utils");
/* eslint-disable @typescript-eslint/naming-convention */
var generateContentId = (0, id_generator_1.default)();
var getPictureOnPictureStateRef = compat_1.events.getPictureOnPictureStateRef, getVideoVisibilityRef = compat_1.events.getVideoVisibilityRef, getElementResolutionRef = compat_1.events.getElementResolutionRef, getScreenResolutionRef = compat_1.events.getScreenResolutionRef;
/**
...
var Player = /** @class */ (function (_super) {
    ...
    Player.prototype._priv_initializeContentPlayback = function (options) {
        ...
        if (!isDirectFile) {
            ...
            if (this._priv_throttleVideoBitrateWhenHidden) {
                if (!relyOnVideoVisibilityAndSize) {
                    ...
                    throttlers.throttleBitrate = {
                        video: (0, reference_1.createMappedReference)(getVideoVisibilityRef(this._priv_pictureInPictureRef, currentContentCanceller.signal), function (isActive) { return isActive ? Infinity : 0; }, currentContentCanceller.signal),
                    };
                }
            }
            ...
            if (mode === "main" || (mode === "auto" && !canRunInMultiThread)) {
                ...
                var transportOptions = { lowLatencyMode: lowLatencyMode, checkMediaSegmentIntegrity: checkMediaSegmentIntegrity, referenceDateTime: referenceDateTime, serverSyncInfos: serverSyncInfos, manifestLoader: undefined,
                    segmentLoader: undefined,
                    representationFilter: options.representationFilter, __priv_manifestUpdateUrl: __priv_manifestUpdateUrl, __priv_patchLastSegmentInSidx: __priv_patchLastSegmentInSidx };
                initializer = new features_1.default.multithread.init({ adaptiveOptions: adaptiveOptions, autoPlay: autoPlay, bufferOptions: bufferOptions, keySystems: keySystems, lowLatencyMode: lowLatencyMode, transportOptions: transportOptions, manifestRequestSettings: manifestRequestSettings, segmentRequestOptions: segmentRequestOptions, speed: this._priv_speed, startAt: startAt, textTrackOptions: textTrackOptions, worker: this._priv_worker, url: url });
            }
        }
        else {
            ...
            initializer = new features_1.default.directfile.initDirectFile({ autoPlay: autoPlay, keySystems: keySystems, speed: this._priv_speed, startAt: startAt, url: url });
        }
        ...
        var playbackObserver = new playback_observer_1.default(videoElement, {
    ...
    Player.prototype._priv_onDecipherabilityUpdate = function (contentInfos, elts) {
        ...
        var periodsAndTrackTypes = elts.reduce(function (acc, elt) {
            var _a, _b, _c;
            var isFound = (0, array_find_1.default)(acc, function (x) { return x[0].id === elt.period.id &&
        ...
        try {
            for (var periodsAndTrackTypes_1 = __values(periodsAndTrackTypes), periodsAndTrackTypes_1_1 = periodsAndTrackTypes_1.next(); !periodsAndTrackTypes_1_1.done; periodsAndTrackTypes_1_1 = periodsAndTrackTypes_1.next()) {
                ...
                this._priv_triggerEventIfNotStopped("representationListUpdate", { period: { start: period.start,
                        end: period.end,
                        id: period.id }, trackType: trackType, reason: "decipherability-update" }, contentInfos.currentContentCanceller.signal);
            }
        }
    ...
    Player.prototype._priv_triggerPositionUpdate = function (contentInfos, observation) {
        ...
        var maximumPosition = manifest !== null ? (0, manifest_1.getMaximumSafePosition)(manifest) :
            undefined;
        var positionData = {
