...
exports.generateReadOnlyObserver = exports.ObservationPosition = void 0;
...
var PlaybackObserver = /** @class */ (function () {
    ...
    PlaybackObserver.prototype._getCurrentObservation = function (event) {
        ...
        var seekingState = isInternalSeeking ? 1 /* SeekingState.Internal */ :
            seeking ? 2 /* SeekingState.External */ :
                0 /* SeekingState.None */;
        var timings = (0, object_assign_1.default)({}, mediaTimings, { position: new ObservationPosition(mediaTimings.position, pendingPosition),
            ...
            freezing: freezingStatus, bufferGap: bufferGap, currentRange: currentRange });
...
exports.ObservationPosition = ObservationPosition;
/**
...
function getMediaInfos(mediaElement) {
    ...
    return { buffered: buffered, position: currentTime, duration: duration, ended: ended, paused: paused, playbackRate: playbackRate, readyState: readyState, seeking: seeking };
}
/**
...
function getRebufferingStatus(_a) {
    ...
    // between two consecutive timeupdates
        ...
        if (canSwitchToRebuffering &&
            ...
            !paused &&
                ...
                (observationEvent === "seeking" && (bufferGap === Infinity || (bufferGap === undefined && readyState < 3))))) {
            shouldRebuffer = true;
        }
        else if (prevRebuffering !== null &&
    ...
    if (shouldStopRebuffer === true) {
        ...
        return { reason: reason, timestamp: (0, monotonic_timestamp_1.default)(),
            position: rebufferEndPosition };
    }
    return null;
}
...
exports.generateReadOnlyObserver = generateReadOnlyObserver;
/**
