...
function parseLoadVideoOptions(options) {
    ...
    var autoPlay = (0, is_null_or_undefined_1.default)(options.autoPlay) ? DEFAULT_AUTO_PLAY :
        !!options.autoPlay;
    ...
    return { __priv_patchLastSegmentInSidx: options.__priv_patchLastSegmentInSidx,
        __priv_manifestUpdateUrl: options.__priv_manifestUpdateUrl,
        /* eslint-enable @typescript-eslint/no-explicit-any */
        /* eslint-enable @typescript-eslint/no-unsafe-assignment */
        /* eslint-enable @typescript-eslint/no-unsafe-member-access */
        checkMediaSegmentIntegrity: options.checkMediaSegmentIntegrity, autoPlay: autoPlay, defaultAudioTrackSwitchingMode: defaultAudioTrackSwitchingMode, enableFastSwitching: enableFastSwitching, initialManifest: initialManifest, keySystems: keySystems, lowLatencyMode: lowLatencyMode, manifestLoader: options.manifestLoader, minimumManifestUpdateInterval: minimumManifestUpdateInterval, requestConfig: requestConfig, onCodecSwitch: onCodecSwitch, referenceDateTime: options.referenceDateTime,
        representationFilter: options.representationFilter,
        segmentLoader: options.segmentLoader,
        serverSyncInfos: options.serverSyncInfos, startAt: startAt, textTrackElement: textTrackElement, textTrackMode: textTrackMode, transport: transport, mode: mode, url: url };
}
