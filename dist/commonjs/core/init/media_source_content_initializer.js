...
var DecipherabilityFreezeDetector_1 = require("./utils/DecipherabilityFreezeDetector");
...
var MediaSourceContentInitializer = /** @class */ (function (_super) {
    ...
    function MediaSourceContentInitializer(settings) {
        ...
        var urls = settings.url === undefined ? undefined :
            [settings.url];
        _this._manifestFetcher = new fetchers_1.ManifestFetcher(urls, settings.transport, settings.manifestRequestSettings);
        return _this;
    }
    /**
    ...
    MediaSourceContentInitializer.prototype.start = function (mediaElement, playbackObserver) {
        ...
        this._initializeMediaSourceAndDecryption(mediaElement, protectionRef)
            .then(function (initResult) { return _this._onInitialMediaSourceReady(mediaElement, initResult.mediaSource, playbackObserver, initResult.drmSystemId, protectionRef, initResult.unlinkMediaSource); })
            .catch(function (err) {
    ...
    MediaSourceContentInitializer.prototype._onInitialMediaSourceReady = function (mediaElement, initialMediaSource, playbackObserver, drmSystemId, protectionRef, initialMediaSourceCanceller) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            function recursivelyLoadOnMediaSource(mediaSource, startingPos, shouldPlay, currentCanceller) {
                var opts = { mediaElement: mediaElement, playbackObserver: playbackObserver, mediaSource: mediaSource, initialTime: startingPos,
                    autoPlay: shouldPlay, manifest: manifest, representationEstimator: representationEstimator, segmentFetcherCreator: segmentFetcherCreator, speed: speed, protectionRef: protectionRef, bufferOptions: subBufferOptions };
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 6:
                        ...
                        segmentFetcherCreator = new fetchers_1.SegmentFetcherCreator(transport, segmentRequestOptions, initCanceller.signal);
    ...
    MediaSourceContentInitializer.prototype._startBufferingOnMediaSource = function (args, onReloadOrder, cancelSignal) {
        ...
        var segmentBuffersStore = new segment_buffers_1.default(mediaSource, mediaElement.nodeName === "VIDEO", textDisplayerInterface);
        cancelSignal.register(function () {
        ...
        var coreObserver = (0, create_core_playback_observer_1.default)(playbackObserver, { autoPlay: autoPlay, manifest: manifest, mediaSource: mediaSource, textDisplayer: textDisplayer, initialPlayPerformed: initialPlayPerformed, speed: speed }, cancelSignal);
        var rebufferingController = this._createRebufferingController(playbackObserver, manifest, speed, cancelSignal);
        var decipherabilityFreezeDetector = new DecipherabilityFreezeDetector_1.default(segmentBuffersStore);
        ...
        var contentTimeBoundariesObserver = (0, create_content_time_boundaries_observer_1.default)(manifest, mediaSource, coreObserver, segmentBuffersStore, {
            onWarning: function (err) { return _this.trigger("warning", err); },
        ...
        autoPlayResult
            ...
            (0, get_loaded_reference_1.default)(playbackObserver, mediaElement, false, cancelSignal)
                ...
                if (isLoaded) {
                    stopListening();
                    _this.trigger("loaded", { segmentBuffersStore: segmentBuffersStore });
                }
        ...
        var self = this;
        (0, stream_1.default)({ manifest: manifest, initialPeriod: initialPeriod }, coreObserver, representationEstimator, segmentBuffersStore, segmentFetcherCreator, bufferOptions, handleStreamOrchestratorCallbacks(), cancelSignal);
        /**
        ...
        function handleStreamOrchestratorCallbacks() {
            return {
                ...
                needsManifestRefresh: function () { return self._manifestFetcher.scheduleManualRefresh({
    ...
    MediaSourceContentInitializer.prototype._createRebufferingController = function (playbackObserver, manifest, speed, cancelSignal) {
        ...
        rebufferingController.addEventListener("warning", function (err) { return _this.trigger("warning", err); });
