...
export default class ContentTimeBoundariesObserver extends EventEmitter<IContentTimeBoundariesObserverEvent> {
     ...
     */
    onAdaptationChange(bufferType: IBufferType, period: Period, adaptation: Adaptation | null): void;
    /**
     ...
     */
    onRepresentationChange(bufferType: IBufferType, period: Period): void;
    /**
     ...
     */
    onPeriodCleared(bufferType: IBufferType, period: Period): void;
    /**
