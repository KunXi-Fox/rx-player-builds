 ...
 */
import { IManifestMetadata, IPeriodMetadata } from "../../../manifest";
...
export default class RebufferingController extends EventEmitter<IRebufferingControllerEvent> {
     ...
     */
    constructor(playbackObserver: PlaybackObserver, manifest: IManifestMetadata | null, speed: IReadOnlySharedReference<number>);
    start(): void;
    /**
