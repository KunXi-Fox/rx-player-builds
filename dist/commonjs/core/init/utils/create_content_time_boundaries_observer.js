...
var content_time_boundaries_observer_1 = require("../utils/content_time_boundaries_observer");
/**
 ...
 * @returns {Object}
 */
function createContentTimeBoundariesObserver(manifest, mediaSource, streamObserver, segmentBuffersStore, callbacks, cancelSignal) {
    cancelSignal.register(function () {
        mediaSource.interruptDurationSetting();
    });
    var contentTimeBoundariesObserver = new content_time_boundaries_observer_1.default(manifest, streamObserver, segmentBuffersStore.getBufferTypes());
    cancelSignal.register(function () {
