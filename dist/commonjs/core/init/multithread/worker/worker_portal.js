...
var create_content_time_boundaries_observer_1 = require("../../utils/create_content_time_boundaries_observer");
...
var worker_playback_observer_1 = require("./worker_playback_observer");
    ...
    onmessage = function (e) {
        ...
        switch (msg.type) {
            case "init" /* MainThreadMessageType.Init */:
                ...
                isInitialized = true;
                var diffMain = msg.value.date - msg.value.timestamp;
                ...
                dashWasmParser.initialize({ wasmUrl: msg.value.dashWasmUrl }).then(function () {
                    (0, send_message_1.default)({ type: "init-success" /* WorkerMessageType.InitSuccess */,
                        value: null });
                }, function (err) {
                    ...
                    (0, send_message_1.default)({ type: "init-error" /* WorkerMessageType.InitError */,
            ...
            case "observation" /* MainThreadMessageType.PlaybackObservation */: {
                ...
                var newBuffered = (0, create_core_playback_observer_1.getBufferedDataPerMediaBuffer)(currentContent.mediaSource, null);
            ...
            case "codec-support-update" /* MainThreadMessageType.CodecSupportUpdate */: {
                ...
                try {
                    ...
                    if (warning !== null) {
                        (0, send_message_1.default)({ type: "warning" /* WorkerMessageType.Warning */,
                            contentId: preparedContent.contentId,
                            value: (0, send_message_1.formatErrorForSender)(warning) });
                    }
                }
                catch (err) {
                    (0, send_message_1.default)({ type: "error" /* WorkerMessageType.Error */,
                        contentId: preparedContent.contentId,
            ...
            default: (0, assert_1.assertUnreachable)(msg);
        }
    };
}
exports.default = initializeWorkerPortal;
function prepareNewContent(contentPreparer, contentInitData) {
    contentPreparer.initializeNewContent(contentInitData).then(function (manifest) {
        (0, send_message_1.default)({ type: "manifest-ready" /* WorkerMessageType.ManifestReady */,
...
function loadOrReloadPreparedContent(val, contentPreparer, playbackObservationRef, parentCancelSignal) {
    ...
    var contentId = preparedContent.contentId, manifest = preparedContent.manifest, mediaSource = preparedContent.mediaSource, representationEstimator = preparedContent.representationEstimator, segmentBuffersStore = preparedContent.segmentBuffersStore, segmentFetcherCreator = preparedContent.segmentFetcherCreator;
    ...
    playbackObservationRef.onUpdate(function (observation) {
        ...
        ["video", "audio", "text"].forEach(function (tType) {
            var _a;
            var segmentBufferStatus = segmentBuffersStore.getStatus(tType);
    ...
    if (initialPeriod === undefined) {
        ...
        (0, send_message_1.default)({ type: "error" /* WorkerMessageType.Error */, contentId: contentId, value: (0, send_message_1.formatErrorForSender)(error) });
        return;
    }
    var playbackObserver = new worker_playback_observer_1.default(playbackObservationRef, contentId, currentLoadCanceller.signal);
    var contentTimeBoundariesObserver = (0, create_content_time_boundaries_observer_1.default)(manifest, mediaSource, playbackObserver, segmentBuffersStore, {
        onWarning: function (err) {
            return (0, send_message_1.default)({ type: "warning" /* WorkerMessageType.Warning */, contentId: contentId, value: (0, send_message_1.formatErrorForSender)(err) });
        },
    ...
    (0, stream_1.default)({ initialPeriod: manifest.periods[0], manifest: manifest }, playbackObserver, representationEstimator, segmentBuffersStore, segmentFetcherCreator, { wantedBufferAhead: globals_1.wantedBufferAhead, maxVideoBufferSize: globals_1.maxVideoBufferSize, maxBufferAhead: globals_1.maxBufferAhead, maxBufferBehind: globals_1.maxBufferBehind, drmSystemId: drmSystemId, enableFastSwitching: enableFastSwitching, onCodecSwitch: onCodecSwitch }, handleStreamOrchestratorCallbacks(), currentLoadCanceller.signal);
    /**
        ...
        return {
            ...
            streamStatusUpdate: function (value) {
                ...
                if (manifest.isLastPeriodKnown &&
                    ...
                    var hasFinishedLoadingLastPeriod = value.hasFinishedLoading ||
                        value.isEmptyStream;
            ...
            warning: function (value) {
                (0, send_message_1.default)({ type: "warning" /* WorkerMessageType.Warning */, contentId: contentId, value: (0, send_message_1.formatErrorForSender)(value) });
            },
            periodStreamReady: function (value) {
                ...
                (0, send_message_1.default)({ type: "period-stream-ready" /* WorkerMessageType.PeriodStreamReady */, contentId: contentId, value: { periodId: value.period.id,
            ...
            periodStreamCleared: function (value) {
                ...
                (0, send_message_1.default)({ type: "period-stream-cleared" /* WorkerMessageType.PeriodStreamCleared */, contentId: contentId, value: { periodId: value.period.id,
                        bufferType: value.type } });
            },
            ...
            needsDecipherabilityFlush: function () {
                (0, send_message_1.default)({ type: "needs-decipherability-flush" /* WorkerMessageType.NeedsDecipherabilityFlush */, contentId: contentId, value: null });
            },
            encryptionDataEncountered: function (values) {
                ...
                try {
                    for (var values_1 = __values(values), values_1_1 = values_1.next(); !values_1_1.done; values_1_1 = values_1.next()) {
                        ...
                        if (content.manifest instanceof manifest_1.default) {
                            content.manifest = content.manifest.getMetadataSnapshot();
                        }
                        if (content.period instanceof manifest_1.Period) {
                            content.period = content.period.getMetadataSnapshot();
                        }
                        if (content.adaptation instanceof manifest_1.Adaptation) {
                            content.adaptation = content.adaptation.getMetadataSnapshot();
                        }
                        if (content.representation instanceof manifest_1.Representation) {
                            content.representation = content.representation.getMetadataSnapshot();
                        }
                        (0, send_message_1.default)({ type: "encryption-data-encountered" /* WorkerMessageType.EncryptionDataEncountered */, contentId: contentId, value: { keyIds: value.keyIds,
                                values: value.values, content: content, type: value.type } });
                    }
                }
    ...
    function sendDiscontinuityUpdateIfNeeded(value) {
        ...
        var msgObj = { periodId: value.period.id,
            bufferType: value.bufferType,
            discontinuity: value.imminentDiscontinuity,
            position: value.position };
        periodMap.set(value.bufferType, msgObj);
        (0, send_message_1.default)({ type: "discontinuity-update" /* WorkerMessageType.DiscontinuityUpdate */, contentId: contentId, value: msgObj });
    }
    function handleMediaSourceReload(payload) {
        ...
        contentPreparer.reloadMediaSource(payload).then(function () {
            ...
            (0, send_message_1.default)({ type: "error" /* WorkerMessageType.Error */, contentId: contentId, value: (0, send_message_1.formatErrorForSender)(err) });
        });
    }
}
function updateLoggerLevel(logLevel, sendBackLogs) {
    if (!sendBackLogs) {
        ...
        log_1.default.setLevel(logLevel, function (levelStr, logs) {
