...
var ContentPreparer = /** @class */ (function () {
    ...
    ContentPreparer.prototype.initializeNewContent = function (context) {
        ...
        return new Promise(function (res, rej) {
            ...
            var unbindRejectOnCancellation = currentMediaSourceCanceller.signal
            ...
            var _c = __read(createMediaSourceAndBuffersStore(contentId, {
                ...
                hasText: hasText,
            }, currentMediaSourceCanceller.signal), 3), mediaSource = _c[0], segmentBuffersStore = _c[1], workerTextSender = _c[2];
            var decipherabilityFreezeDetector = new DecipherabilityFreezeDetector_1.default(segmentBuffersStore);
            _this._currentContent = { contentId: contentId, decipherabilityFreezeDetector: decipherabilityFreezeDetector, mediaSource: mediaSource, manifest: null, manifestFetcher: manifestFetcher, representationEstimator: representationEstimator, segmentBuffersStore: segmentBuffersStore, segmentFetcherCreator: segmentFetcherCreator, workerTextSender: workerTextSender, trackChoiceSetter: trackChoiceSetter };
            ...
            manifestFetcher.addEventListener("warning", function (err) {
                (0, send_message_1.default)({ type: "warning" /* WorkerMessageType.Warning */, contentId: contentId, value: (0, send_message_1.formatErrorForSender)(err) });
            ...
            function checkIfReadyAndValidate() {
                ...
                manifest.addEventListener("manifestUpdate", function (updates) {
                    ...
                    // clone.
                    var snapshot = (0, object_assign_1.default)(manifest.getMetadataSnapshot(), { periods: [] });
    ...
    ContentPreparer.prototype.reloadMediaSource = function (reloadInfo) {
        ...
        }, this._currentMediaSourceCanceller.signal), 3), mediaSource = _a[0], segmentBuffersStore = _a[1], workerTextSender = _a[2];
...
function createMediaSourceAndBuffersStore(contentId, capabilities, cancelSignal) {
    ...
    if (capabilities.hasMseInWorker) {
        ...
        if (handle.type === "handle") {
            sentMediaSourceLink = { type: "handle",
                value: handle.value };
        }
        else {
            var url_1 = URL.createObjectURL(handle.value);
            sentMediaSourceLink = { type: "url",
                value: url_1 };
    ...
    var segmentBuffersStore = new segment_buffers_1.default(mediaSource, hasVideo, textSender);
    cancelSignal.register(function () {
