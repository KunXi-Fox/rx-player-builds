...
function BufferGarbageCollector(_a, cancellationSignal) {
    ...
    function clean() {
        ...
        clearBuffer(segmentBuffer, lastPosition, lastBuffered, maxBufferBehind.getValue(), maxBufferAhead.getValue(), cancellationSignal)
            .catch(function (e) {
 ...
 * @returns {Promise}
 */
function clearBuffer(segmentBuffer, position, buffered, maxBufferBehind, maxBufferAhead, cancellationSignal) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    log_1.default.debug("GC: cleaning range from SegmentBuffer", range.start, range.end);
