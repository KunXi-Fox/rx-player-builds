...
var AudioVideoSegmentBuffer = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        promise = Promise.all(dataToPush.map(function (data) {
                            ...
                            return _this._sourceBuffer.appendBuffer(data, { codec: codec, timestampOffset: timestampOffset, appendWindow: appendWindow });
                        }));
     ...
     * @returns {Promise}
     */
    AudioVideoSegmentBuffer.prototype.signalSegmentComplete = function (infos) {
        return __awaiter(this, void 0, void 0, function () {
            var promise, _1;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @returns {Object}
     */
    AudioVideoSegmentBuffer.prototype._getActualDataToPush = function (data) {
    ...
    AudioVideoSegmentBuffer.prototype._addToOperationQueue = function (promise, operation) {
        var _this = this;
...
exports.default = AudioVideoSegmentBuffer;
/**
