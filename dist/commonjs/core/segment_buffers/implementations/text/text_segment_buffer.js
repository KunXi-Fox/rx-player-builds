 ...
 */
var TextSegmentBuffer = /** @class */ (function (_super) {
    __extends(TextSegmentBuffer, _super);
    /**
     * @param {Object} textDisplayerSender
     */
    function TextSegmentBuffer(textDisplayerSender) {
        var _this = this;
        log_1.default.debug("HTSB: Creating TextSegmentBuffer");
     ...
     */
    TextSegmentBuffer.prototype.declareInitSegment = function (uniqueId) {
        log_1.default.warn("HTSB: Declaring initialization segment for  Text SegmentBuffer", uniqueId);
    };
    /**
     * @param {string} uniqueId
     */
    TextSegmentBuffer.prototype.freeInitSegment = function (uniqueId) {
        log_1.default.warn("HTSB: Freeing initialization segment for  Text SegmentBuffer", uniqueId);
    };
    /**
     ...
     * @returns {Promise}
     */
    TextSegmentBuffer.prototype.pushChunk = function (infos) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this._addToOperationQueue(promise, { type: types_1.SegmentBufferOperation.Push,
                            value: infos });
     ...
     * @returns {Promise}
     */
    TextSegmentBuffer.prototype.removeBuffer = function (start, end) {
        return __awaiter(this, void 0, void 0, function () {
            var promise, ranges;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this._addToOperationQueue(promise, { type: types_1.SegmentBufferOperation.Remove,
     ...
     * @returns {Promise}
     */
    TextSegmentBuffer.prototype.signalSegmentComplete = function (infos) {
        return __awaiter(this, void 0, void 0, function () {
            var promise, _1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this._addToOperationQueue(promise, {
                            type: types_1.SegmentBufferOperation.SignalSegmentComplete,
                            value: infos,
                        });
                        _a.label = 1;
                    case 1:
     ...
     */
    TextSegmentBuffer.prototype.getPendingOperations = function () {
        return this._pendingOperations.map(function (p) { return p.operation; });
    };
    TextSegmentBuffer.prototype.dispose = function () {
        log_1.default.debug("HTSB: Disposing TextSegmentBuffer");
        this._sender.reset();
    };
    TextSegmentBuffer.prototype._addToOperationQueue = function (promise, operation) {
        var _this = this;
    ...
    return TextSegmentBuffer;
}(types_1.SegmentBuffer));
exports.default = TextSegmentBuffer;
/**
