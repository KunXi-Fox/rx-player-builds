...
var ManifestFetcher = /** @class */ (function (_super) {
    ...
    ManifestFetcher.prototype._recursivelyRefreshManifest = function (manifest, _a) {
        ...
        this.scheduleManualRefresh = function (settings) {
            ...
            var timeoutId = setTimeout(function () {
                ...
                _this._triggerNextManifestRefresh(manifest, { enablePartialRefresh: enablePartialRefresh, unsafeMode: unsafeMode });
        ...
        if (manifest.expired !== null) {
            var timeoutId_1 = setTimeout(function () {
                ...
                (_a = manifest.expired) === null || _a === void 0 ? void 0 : _a.then(function () {
                    nextRefreshCanceller.cancel();
                    _this._triggerNextManifestRefresh(manifest, { enablePartialRefresh: false,
    ...
    ManifestFetcher.prototype._triggerNextManifestRefresh = function (manifest, _a) {
        ...
        this._fetchManifest(refreshURL)
            .then(function (res) { return res.parse({ externalClockOffset: externalClockOffset, previousManifest: manifest, unsafeMode: unsafeMode }); })
            .then(function (res) {
            _this._isRefreshPending = false;
            ...
            _this._recursivelyRefreshManifest(manifest, { sendingTime: newSendingTime, parsingTime: parsingTime, updatingTime: updatingTime });
        })
            .catch(function (err) {
            _this._isRefreshPending = false;
