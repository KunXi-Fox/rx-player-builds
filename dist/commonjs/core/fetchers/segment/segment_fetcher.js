            ...
            function generateParserFunction(data, isChunked) {
                ...
                return function parse(initTimescale) {
                    ...
                    try {
                        ...
                        throw (0, errors_1.formatError)(error, { defaultCode: "PIPELINE_PARSE_ERROR",
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        metricsSent = false;
                        context = { segment: segment, type: adaptation.type,
                        ...
                        (_a = lifecycleCallbacks.onRequestBegin) === null || _a === void 0 ? void 0 : _a.call(lifecycleCallbacks, { requestTimestamp: (0, monotonic_timestamp_1.default)(),
