...
function AdaptationStream(_a, callbacks, parentCancelSignal) {
    ...
    var initialRepresentations = content.adaptation.representations.filter(function (r) { return (0, array_includes_1.default)(initialRepIds, r.id) &&
    ...
    content.representations.onUpdate(function (val) {
        ...
        var newRepresentations = content.adaptation.representations.filter(function (r) { return (0, array_includes_1.default)(newRepIds, r.id); });
    ...
    function onRepresentationsChoiceChange(choice, fnCancelSignal) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        switchStrat = (0, get_representations_switch_strategy_1.default)(period, adaptation, choice, segmentBuffer, playbackObserver);
                        _a = switchStrat.type;
                        switch (_a) {
                    ...
                    case 4:
                        ...
                        range = _c.value;
                        return [4 /*yield*/, segmentBuffer.removeBuffer(range.start, range.end)];
                    case 5:
                        _e.sent();
                        if (fnCancelSignal.isCancelled()) {
                            return [2 /*return*/];
    ...
    function recursivelyCreateRepresentationStreams(fnCancelSignal) {
        ...
        var repInfo = { type: adaptation.type, adaptation: adaptation, period: period, representation: representation };
    ...
    function createRepresentationStream(representation, terminateCurrentStream, representationStreamCallbacks, fnCancelSignal) {
        ...
        var maxBufferSize = adaptation.type === "video" ?
            maxVideoBufferSize :
            new reference_1.default(Infinity);
        ...
        var updatedCallbacks = (0, object_assign_1.default)({}, representationStreamCallbacks, {
            error: function (err) {
                ...
                if (formattedError.code !== "BUFFER_FULL_ERROR") {
                    ...
                    (0, cancellable_sleep_1.default)(4000, adapStreamCanceller.signal).then(function () {
        ...
        (0, representation_1.default)({ playbackObserver: playbackObserver, content: { representation: representation, adaptation: adaptation, period: period, manifest: manifest }, segmentBuffer: segmentBuffer, segmentFetcher: segmentFetcher, terminate: terminateCurrentStream,
