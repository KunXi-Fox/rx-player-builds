...
function getRepresentationsSwitchingStrategy(period, adaptation, settings, segmentBuffer, playbackObserver) {
    var e_1, _a, e_2, _b;
    var _c, _d;
    if (settings.switchingMode === "lazy") {
        return { type: "continue", value: undefined };
    }
    var inventory = segmentBuffer.getLastKnownInventory();
    var unwantedRange = [];
    try {
        for (var inventory_1 = __values(inventory), inventory_1_1 = inventory_1.next(); !inventory_1_1.done; inventory_1_1 = inventory_1.next()) {
            ...
            if (elt.infos.period.id === period.id && (elt.infos.adaptation.id !== adaptation.id ||
                ...
                (0, ranges_1.insertInto)(unwantedRange, { start: (_c = elt.bufferedStart) !== null && _c !== void 0 ? _c : elt.start,
    ...
    var pendingOperations = segmentBuffer.getPendingOperations();
    try {
        for (var pendingOperations_1 = __values(pendingOperations), pendingOperations_1_1 = pendingOperations_1.next(); !pendingOperations_1_1.done; pendingOperations_1_1 = pendingOperations_1.next()) {
            ...
            if (operation.type === segment_buffers_1.SegmentBufferOperation.Push) {
    ...
    var lastSegmentBefore = (0, segment_buffers_1.getLastSegmentBeforePeriod)(inventory, period);
    ...
    if (period.end !== undefined) {
        ...
        var firstSegmentAfter = (0, segment_buffers_1.getFirstSegmentAfterPeriod)(inventory, period);
