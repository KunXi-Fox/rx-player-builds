...
function PeriodStream(_a, callbacks, parentCancelSignal) {
    ...
    adaptationRef.onUpdate(function (choice) {
        ...
        (function () { return __awaiter(_this, void 0, void 0, function () {
            var streamCanceller, segmentBufferStatus, periodEnd, adaptations, adaptation, DELTA_POSITION_AFTER_RELOAD, relativePosHasBeenDefaulted, relativePosAfterSwitch, representations, segmentBuffer, strategy, _a, _b, _c, start, end, e_1_1;
            var e_1, _d;
            var _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        if (!(segmentBufferStatus.type === "initialized")) return [3 /*break*/, 5];
                        log_1.default.info("Stream: Clearing previous ".concat(bufferType, " SegmentBuffer"));
                        if (!segment_buffers_1.default.isNative(bufferType)) return [3 /*break*/, 1];
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, segmentBufferStatus.value.removeBuffer(period.start, periodEnd)];
                    case 3:
                        _f.sent();
                    ...
                    case 7:
                        ...
                        adaptation = (0, array_find_1.default)(adaptations !== null && adaptations !== void 0 ? adaptations : [], function (a) {
                            return a.id === choice.adaptationId;
                        });
                        ...
                        if (segment_buffers_1.default.isNative(bufferType) &&
                        ...
                        segmentBuffer = createOrReuseSegmentBuffer(segmentBuffersStore, bufferType, adaptation);
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, segmentBuffer.removeBuffer(start, end)];
                    case 11:
                        _f.sent();
                        if (streamCanceller.isUsed()) {
                            return [2 /*return*/]; // The Stream has since been cancelled
                    ...
                    case 16:
                        if (strategy.type === "flush-buffer") {
                            ...
                            callbacks.needsBufferFlush({ relativeResumingPosition: relativePosAfterSwitch, relativePosHasBeenDefaulted: relativePosHasBeenDefaulted });
                            if (streamCanceller.isUsed()) {
    ...
    function askForMediaSourceReload(timeOffset, stayInPeriod, cancelSignal) {
        ...
        (0, queue_microtask_1.default)(function () {
            playbackObserver.listen(function () {
                ...
                callbacks.waitingMediaSourceReload({ bufferType: bufferType, period: period, timeOffset: timeOffset, stayInPeriod: stayInPeriod });
 ...
 * @returns {Object}
 */
function createOrReuseSegmentBuffer(segmentBuffersStore, bufferType, adaptation) {
    var segmentBufferStatus = segmentBuffersStore.getStatus(bufferType);
    if (segmentBufferStatus.type === "initialized") {
        log_1.default.info("Stream: Reusing a previous SegmentBuffer for the type", bufferType);
...
function getFirstDeclaredMimeType(adaptation) {
    ...
    if (representations.length === 0) {
        var noRepErr = new errors_1.MediaError("NO_PLAYABLE_REPRESENTATION", "No Representation in the chosen " +
            adaptation.type + " Adaptation can be played", { tracks: [(0, manifest_1.toTaggedTrack)(adaptation)] });
        throw noRepErr;
    }
...
function createEmptyAdaptationStream(playbackObserver, wantedBufferAhead, bufferType, content, callbacks, cancelSignal) {
    ...
    wantedBufferAhead.onUpdate(sendStatus, { emitCurrentValue: false, clearSignal: cancelSignal });
    playbackObserver.listen(sendStatus, { includeLastObservation: false, clearSignal: cancelSignal });
    sendStatus();
    function sendStatus() {
