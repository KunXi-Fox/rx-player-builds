...
import SegmentBuffersStore, { IBufferType, SegmentBuffer } from "../../segment_buffers";
import { IAdaptationChoice, IAdaptationStreamCallbacks, IAdaptationStreamOptions } from "../adaptation";
...
export interface IPeriodStreamArguments {
    ...
    garbageCollectors: WeakMapMemory<SegmentBuffer, (cancelSignal: CancellationSignal) => void>;
