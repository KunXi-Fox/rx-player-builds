...
function RepresentationStream(_a, callbacks, parentCancelSignal) {
    ...
    downloadingQueue.addEventListener("fullyLoadedSegment", function (segment) {
        segmentBuffer.signalSegmentComplete((0, object_assign_1.default)({ segment: segment }, content))
    ...
    function onParsedChunk(evt) {
        ...
        if (evt.segmentType === "init") {
            ...
            if (evt.initializationData !== null) {
                ...
                (0, push_init_segment_1.default)({ playbackObserver: playbackObserver, bufferGoal: bufferGoal, content: content, initSegmentUniqueId: initSegmentUniqueId, segment: evt.segment,
            ...
            (0, push_media_segment_1.default)({ playbackObserver: playbackObserver, bufferGoal: bufferGoal, content: content, initSegmentUniqueId: initSegmentUniqueId, parsedSegment: evt,
