...
import { IRepresentationStreamArguments, IRepresentationStreamCallbacks } from "./types";
/**
 ...
 * doing.
 */
export default function RepresentationStream<TSegmentDataType>({ content, options, playbackObserver, segmentBuffer, segmentFetcher, terminate }: IRepresentationStreamArguments<TSegmentDataType>, callbacks: IRepresentationStreamCallbacks, parentCancelSignal: CancellationSignal): void;
