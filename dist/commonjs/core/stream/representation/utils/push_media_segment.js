...
function pushMediaSegment(_a, cancelSignal) {
    var _b, _c;
    var playbackObserver = _a.playbackObserver, bufferGoal = _a.bufferGoal, content = _a.content, initSegmentUniqueId = _a.initSegmentUniqueId, parsedSegment = _a.parsedSegment, segment = _a.segment, segmentBuffer = _a.segmentBuffer;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    inventoryInfos = (0, object_assign_1.default)({ segment: segment, chunkSize: chunkSize, start: estimatedStart,
