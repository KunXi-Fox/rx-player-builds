...
function checkForDiscontinuity(content, checkedRange, nextSegmentStart, hasFinishedLoading, bufferedSegments) {
    ...
    nextBufferedSegment.bufferedStart !== undefined &&
        ...
        log_1.default.debug("RS: current discontinuity encountered", adaptation.type, nextBufferedSegment.bufferedStart);
        return { start: undefined,
            end: discontinuityEnd };
    }
    ...
    if (nextHoleIdx !== null) {
        ...
        if (nextSegmentStart === null ||
            ...
            log_1.default.debug("RS: future discontinuity encountered", adaptation.type, start, end);
        ...
        if (hasFinishedLoading && period.end !== undefined) { // Period is finished
            ...
            if (lastBufferedInPeriodIdx !== null) {
                ...
                if (lastSegment.bufferedEnd !== undefined &&
                    ...
                    log_1.default.debug("RS: discontinuity encountered at the end of the current period", adaptation.type, lastSegment.bufferedEnd, period.end);
...
exports.default = checkForDiscontinuity;
/**
...
function getIndexOfFirstDiscontinuityBetweenChunks(bufferedChunks, range, startFromIndex) {
    if (startFromIndex <= 0) {
        log_1.default.error("RS: Asked to check a discontinuity before the first chunk.");
        return null;
    }
