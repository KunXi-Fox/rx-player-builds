...
function StreamOrchestrator(content, playbackObserver, representationEstimator, segmentBuffersStore, segmentFetcherCreator, options, callbacks, orchestratorCancelSignal) {
    ...
    try {
        ...
        for (var _c = __values(segmentBuffersStore.getBufferTypes()), _d = _c.next(); !_d.done; _d = _c.next()) {
    ...
    function manageEveryStreams(bufferType, basePeriod) {
        ...
        function onDecipherabilityUpdates(updates) {
            return __awaiter(this, void 0, void 0, function () {
                var segmentBufferStatus, ofCurrentType, segmentBuffer, resettedContent, undecipherableContent, undecipherableRanges, rangesToRemove, period, _a, _b, _c, start, end, e_2_1;
                var e_2, _d;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            undecipherableRanges = (0, get_time_ranges_for_content_1.default)(segmentBuffer, undecipherableContent);
                            rangesToRemove = (0, get_time_ranges_for_content_1.default)(segmentBuffer, resettedContent);
        ...
        var periodStreamCallbacks = __assign(__assign({}, consecutivePeriodStreamCb), { streamStatusUpdate: function (value) {
                if (value.hasFinishedLoading) {
                    ...
                    consecutivePeriodStreamCb
                        .periodStreamCleared({ type: bufferType, manifest: manifest, period: nextStreamInfo.period });
