...
var VideoThumbnailLoader = /** @class */ (function () {
    ...
    VideoThumbnailLoader.prototype.setTime = function (time) {
        ...
        if (!(manifest instanceof manifest_1.default)) {
        ...
        if (log_1.default.hasLevel("DEBUG")) {
            log_1.default.debug("VTL: Found thumbnail for time", time, neededSegments.map(function (s) {
        ...
        return lastRepInfo.sourceBuffer
            ...
            throw new video_thumbnail_loader_error_1.default("LOADING_ERROR", "VideoThumbnailLoaderError: Error when initializing buffers: " +
                String(err));
        })
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _loop_1 = function (segment) {
                            var pending_1 = (0, array_find_1.default)(lastRepInfo.pendingRequests, function (_a) {
                            ...
                            if (pending_1 !== undefined) {
                                ...
                                var prom = (0, load_and_push_segment_1.default)(segmentInfo, sourceBufferInterface, lastRepInfo.segmentFetcher, requestCanceller.signal)
