 ...
 * @returns {Promise}
 */
export default function removeBufferAroundTime(videoElement: HTMLMediaElement, sourceBufferInterface: MainSourceBufferInterface, time: number, margin: number | undefined): Promise<unknown>;
