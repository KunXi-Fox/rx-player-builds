...
function toAudioRepresentation(representation) {
    ...
    return { id: id, bitrate: bitrate, codec: codecs === null || codecs === void 0 ? void 0 : codecs[0], isSpatialAudio: isSpatialAudio, isCodecSupported: isSupported, decipherable: decipherable };
}
/**
...
function toVideoRepresentation(representation) {
    ...
    return { id: id, bitrate: bitrate, frameRate: frameRate, width: width, height: height, codec: codecs === null || codecs === void 0 ? void 0 : codecs[0], hdrInfo: hdrInfo, isCodecSupported: isSupported, decipherable: decipherable };
}
