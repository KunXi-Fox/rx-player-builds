...
function updatePeriodInPlace(oldPeriod, newPeriod, updateType) {
    ...
    var _loop_1 = function (j) {
        ...
        if (newAdaptationIdx === -1) {
            log_1.default.warn("Manifest: Adaptation \"" +
                oldAdaptations[j].id +
            ...
            res.updatedAdaptations.push({ adaptation: oldAdaptation.id,
                trackType: oldAdaptation.type, updatedRepresentations: updatedRepresentations, addedRepresentations: addedRepresentations, removedRepresentations: removedRepresentations });
            ...
            var _loop_2 = function (k) {
                ...
                var newRepresentationIdx = (0, array_find_index_1.default)(newRepresentations, function (representation) {
    ...
    if (newAdaptations.length > 0) {
        log_1.default.warn("Manifest: ".concat(newAdaptations.length, " new Adaptations ") +
            "found when merging.");
        try {
