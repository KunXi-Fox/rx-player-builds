...
function getTrackFragmentDecodeTime(buffer) {
    ...
    var version = tfdt[0];
    return version === 1 ? (0, byte_parsing_1.be8toi)(tfdt, 4) :
        version === 0 ? (0, byte_parsing_1.be4toi)(tfdt, 4) :
            undefined;
}
...
function getMDHDTimescale(buffer) {
    ...
    cursor += 4;
    return version === 1 ? (0, byte_parsing_1.be4toi)(mdhd, cursor + 16) :
        version === 0 ? (0, byte_parsing_1.be4toi)(mdhd, cursor + 8) :
            undefined;
}
...
function getKeyIdFromInitSegment(segment) {
    var stsd = (0, get_box_1.getChildBox)(segment, [0x6D6F6F76 /* moov */,
        0x7472616B /* trak */,
        0x6D646961 /* mdia */,
        0x6D696E66 /* minf */,
        0x7374626C /* stbl */,
    ...
    var tenc = (0, get_box_1.getChildBox)(encBox.subarray(encContentOffset), [0x73696e66 /* sinf */,
        0x73636869 /* schi */,
        0x74656e63 /* tenc */]);
