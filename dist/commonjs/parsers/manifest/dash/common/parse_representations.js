...
function parseRepresentations(representationsIR, adaptation, context) {
    ...
    var _loop_1 = function (representation) {
        ...
        var unsafelyBaseOnPreviousRepresentation = (_c = (_b = context
        ...
        if (representation.children.contentProtections !== undefined) {
            contentProtectionsIr.push.apply(contentProtectionsIr, __spreadArray([], __read(representation.children.contentProtections), false));
        }
        if (contentProtectionsIr.length > 0) {
            var contentProtections = contentProtectionsIr
                ...
                if (systemId !== undefined) {
                    ...
                    var values = [];
                    try {
                        for (var cencPssh_1 = (e_2 = void 0, __values(cencPssh)), cencPssh_1_1 = cencPssh_1.next(); !cencPssh_1_1.done; cencPssh_1_1 = cencPssh_1.next()) {
                    ...
                    if (values.length > 0) {
                        var cencInitData = (0, array_find_1.default)(acc.initData, function (i) { return i.type === "cenc"; });
