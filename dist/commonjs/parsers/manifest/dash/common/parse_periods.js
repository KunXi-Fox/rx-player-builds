    ...
    try {
        for (var baseIr_1 = __values(baseIr), baseIr_1_1 = baseIr_1.next(); !baseIr_1_1.done; baseIr_1_1 = baseIr_1.next()) {
            ...
            var allNamespaces = xmlNamespaces
                .concat((_c = eventStreamIr.attributes.namespaces) !== null && _c !== void 0 ? _c : []);
            try {
                    ...
                    if (eventIr.eventStreamData !== undefined) {
                        ...
                        if (!is_worker_1.default && eventIr.eventStreamData instanceof Element) {
                            ...
                            try {
                                ...
                                log_1.default.error("DASH: Error while parsing event-stream:", err instanceof Error ? err.message :
                                    "Unknown error");
                            }
                        }
