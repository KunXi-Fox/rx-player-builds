...
function parseCompleteIntermediateRepresentation(mpdIR, args, warnings, xlinkInfos) {
    ...
    var _d = (0, get_minimum_and_maximum_positions_1.default)(parsedPeriods), minimumSafePosition = _d.minimumSafePosition, maximumSafePosition = _d.maximumSafePosition, maximumUnsafePosition = _d.maximumUnsafePosition;
    ...
    var parsedMPD = {
        ...
        lifetime: lifetime,
        uris: args.url == null ?
            rootChildren.locations : __spreadArray([args.url], __read(rootChildren.locations), false),
    };
