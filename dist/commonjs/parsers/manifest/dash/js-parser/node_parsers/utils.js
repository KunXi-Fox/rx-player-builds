...
exports.parseScheme = exports.parseMPDInteger = exports.parseMPDFloat = exports.parseMaybeDividedNumber = exports.parseIntOrBoolean = exports.parseDuration = exports.parseDateTime = exports.parseByteRange = exports.parseBoolean = exports.parseBase64 = exports.ValueParser = exports.MPDError = void 0;
// XML-Schema
...
function parseDuration(val, displayName) {
    ...
    var duration = (parseFloat((0, is_non_empty_string_1.default)(match[2]) ? match[2] :
        "0") * 365 * 24 * 60 * 60 +
        parseFloat((0, is_non_empty_string_1.default)(match[4]) ? match[4] :
            "0") * 30 * 24 * 60 * 60 +
        parseFloat((0, is_non_empty_string_1.default)(match[6]) ? match[6] :
            "0") * 24 * 60 * 60 +
        parseFloat((0, is_non_empty_string_1.default)(match[8]) ? match[8] :
            "0") * 60 * 60 +
        parseFloat((0, is_non_empty_string_1.default)(match[10]) ? match[10] :
            "0") * 60 +
        parseFloat((0, is_non_empty_string_1.default)(match[12]) ? match[12] :
            "0"));
