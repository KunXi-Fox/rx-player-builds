 ...
 */
declare function parseBoolean(val: string, displayName: string): [
    boolean,
    MPDError | null
];
/**
 ...
 */
declare function parseMPDInteger(val: string, displayName: string): [
    number | null,
    MPDError | null
];
/**
 ...
 * @returns {Array.<number | Error | null>}
 */
declare function parseMPDFloat(val: string, displayName: string): [
    number | null,
    MPDError | null
];
/**
 ...
 */
declare function parseIntOrBoolean(val: string, displayName: string): [
    boolean | number | null,
    MPDError | null
];
/**
 ...
 */
declare function parseDateTime(val: string, displayName: string): [
    number | null,
    MPDError | null
];
/**
 ...
 * @returns {Array.<number | Error | null>}
 */
declare function parseDuration(val: string, displayName: string): [
    number | null,
    MPDError | null
];
/**
