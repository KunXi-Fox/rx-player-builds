...
function createSmoothStreamingParser(parserOptions) {
    ...
    function parseAdaptation(args) {
        ...
        var adaptationID = adaptationType +
            ((0, is_non_empty_string_1.default)(language) ? ("_" + language) :
                "");
        var representations = qualityLevels.map(function (qualityLevel) {
            ...
            var reprIndex = new representation_index_1.default({ isLive: isLive, sharedSmoothTimeline: sharedSmoothTimeline, media: media, segmentPrivateInfos: segmentPrivateInfos });
            var representation = (0, object_assign_1.default)({}, qualityLevel, { index: reprIndex,
                cdnMetadata: [
                    { baseUrl: baseUrl },
        ...
        var parsedAdaptation = { id: adaptationID,
            type: adaptationType, representations: representations, language: language == null ?
                undefined :
                language };
    ...
    function parseFromDocument(doc, url, manifestReceivedTime) {
        ...
        var timescaleAttr = root.getAttribute("Timescale");
        var timescale = !(0, is_non_empty_string_1.default)(timescaleAttr) ? 10000000 :
        ...
        if (isLive) {
            ...
            maximumTimeData = { isLinear: true, maximumSafePosition: maximumSafePosition, livePosition: livePosition, time: (0, monotonic_timestamp_1.default)() };
