...
function parseTimestamp(timestampString) {
    ...
    if ((0, is_non_empty_string_1.default)(splittedTS[2]) || (0, is_non_empty_string_1.default)(splittedTS[1])) {
        var hours = (0, is_non_empty_string_1.default)(splittedTS[2]) ? parseInt(splittedTS[2], 10) :
            0;
