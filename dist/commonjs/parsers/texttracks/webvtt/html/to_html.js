...
var convert_payload_to_html_1 = require("./convert_payload_to_html");
var create_style_attribute_1 = require("./create_style_attribute");
/**
...
function toHTML(cueObj, styling) {
    var start = cueObj.start, end = cueObj.end, settings = cueObj.settings, header = cueObj.header, payload = cueObj.payload;
    ...
    var pAttr = (0, create_style_attribute_1.default)(settings);
    ...
    var localStyle = (0, is_non_empty_string_1.default)(header) ? classes[header] :
        undefined;
    ...
    attr.value += styles;
    spanElement.setAttributeNode(attr);
    (0, convert_payload_to_html_1.default)(payload.join("\n"), classes)
        .forEach(function (element) {
        spanElement.appendChild(element);
    });
    region.appendChild(pElement);
    pElement.appendChild(spanElement);
    return { start: start, end: end, element: region };
}
