...
function applyPadding(element, padding) {
    ...
    if (firstPadding[2] === "px" ||
        ...
        (0, compat_1.addClassName)(element, "proportional-style");
        if (splittedPadding.length === 1) {
        ...
        log_1.default.warn("TTML Parser: unhandled padding unit:", firstPadding[2]);
    }
    if (splittedPadding.length === 1) {
        return;
    }
    ...
    if (secondPadding[2] === "px" ||
        ...
        log_1.default.warn("TTML Parser: unhandled padding unit:", secondPadding[2]);
    }
    ...
    if (thirdPadding[2] === "px" ||
        ...
        log_1.default.warn("TTML Parser: unhandled padding unit:", thirdPadding[2]);
    }
    ...
    if (fourthPadding[2] === "px" ||
        ...
        log_1.default.warn("TTML Parser: unhandled padding unit:", fourthPadding[2]);
    }
}
