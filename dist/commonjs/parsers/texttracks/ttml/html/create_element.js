    ...
    if ((0, is_non_empty_string_1.default)(textOutline)) {
        ...
        if (len === 3) {
            ...
            element.style.textShadow =
                (0, generate_css_test_outline_1.default)(outlineColor, thickness);
        }
...
function applyGeneralStyle(element, style) {
    ...
    element.style.overflow = (0, is_non_empty_string_1.default)(overflow) ? overflow :
        "hidden";
    // applies to region
    ...
    function loop(node, style, spans, shouldTrimWhiteSpaceFromParent) {
        ...
        for (var i = 0; i < childNodes.length; i++) {
            ...
            if (currentNode.nodeName === "#text") {
                ...
                var shouldTrimWhiteSpaceOnSpan = (0, is_non_empty_string_1.default)(spaceAttribute) ? spaceAttribute === "default" :
