...
function parseCue(parsedCue) {
    ...
    var element = (0, create_element_1.default)(paragraph, body, regionStyles, idStyles, paragraphStyle, { cellResolution: cellResolution, shouldTrimWhiteSpace: shouldTrimWhiteSpace });
