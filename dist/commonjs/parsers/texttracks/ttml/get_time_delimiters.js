...
function getTimeDelimiters(element, ttParams) {
    ...
    var start = (0, is_non_empty_string_1.default)(beginAttr) ? (0, time_parsing_1.default)(beginAttr, ttParams) :
        null;
    var duration = (0, is_non_empty_string_1.default)(durationAttr) ? (0, time_parsing_1.default)(durationAttr, ttParams) :
        null;
    var parsedEnd = (0, is_non_empty_string_1.default)(endAttr) ? (0, time_parsing_1.default)(endAttr, ttParams) :
        null;
