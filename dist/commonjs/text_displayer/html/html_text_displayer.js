...
var onEnded = compat_1.events.onEnded, onSeeked = compat_1.events.onSeeked, onSeeking = compat_1.events.onSeeking;
/**
...
var HTMLTextDisplayer = /** @class */ (function () {
    ...
    HTMLTextDisplayer.prototype._displayCues = function (elements) {
        ...
        if (proportionalCues.length > 0) {
            ...
            var heightWidthRef = (0, compat_1.onHeightWidthChange)(this._textTrackElement, TEXT_TRACK_SIZE_CHECKS_INTERVAL, this._sizeUpdateCanceller.signal);
