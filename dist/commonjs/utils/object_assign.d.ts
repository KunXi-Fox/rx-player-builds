 ...
 */
type MergeRecursively<T extends object, S extends object[]> = S extends [infer First, ...infer Rest] ? MergeRecursively<MergeObjects<T, First extends object ? First : never>, Rest extends object[] ? Rest : never> : T;
