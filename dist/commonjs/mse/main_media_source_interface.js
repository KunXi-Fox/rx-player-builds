...
var end_of_stream_1 = require("../core/init/utils/end_of_stream");
var media_source_duration_updater_1 = require("../core/init/utils/media_source_duration_updater");
...
var MainMediaSourceInterface = /** @class */ (function (_super) {
    ...
    function MainMediaSourceInterface(id) {
        ...
        if ((0, is_null_or_undefined_1.default)(compat_1.MediaSource_)) {
...
var MainSourceBufferInterface = /** @class */ (function () {
    ...
    MainSourceBufferInterface.prototype.appendBuffer = function () {
        ...
        return this._addToQueue({ operationName: 0 /* SbiOperationName.Push */,
            params: args });
    };
    /** @see ISourceBufferInterface */
    MainSourceBufferInterface.prototype.remove = function (start, end) {
        ...
        return this._addToQueue({ operationName: 1 /* SbiOperationName.Remove */,
            params: [start, end] });
    };
    /** @see ISourceBufferInterface */
    ...
    MainSourceBufferInterface.prototype._addToQueue = function (operation) {
        ...
        return new Promise(function (resolve, reject) {
            var shouldRestartQueue = _this._operationQueue.length === 0 &&
                _this._currentOperations.length === 0;
    ...
    MainSourceBufferInterface.prototype._performNextOperation = function () {
        ...
        if (nextElem === undefined) {
            ...
            this._currentOperations = [{ operationName: 0 /* SbiOperationName.Push */,
    ...
    MainSourceBufferInterface.prototype._appendBufferNow = function (data, params) {
        ...
        if (codec !== undefined && codec !== this.codec) {
            ...
            var hasUpdatedSourceBufferType = (0, compat_1.tryToChangeSourceBufferType)(sourceBuffer, codec);
