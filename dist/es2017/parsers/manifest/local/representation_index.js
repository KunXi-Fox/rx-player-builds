 ...
 */
import log from "../../../log";
export default class LocalRepresentationIndex {
    constructor(index, representationId) {
        this._index = index;
    ...
    awaitSegmentBetween(start, end) {
        ...
        return this._index.incomingRanges.some((range) => range.start < end && range.end > start);
    }
    /**
     * @returns {Boolean}
     */
