...
export type IEventPayload<TEventRecord, TEventName extends keyof TEventRecord> = TEventRecord[TEventName];
export type IListener<TEventRecord, TEventName extends keyof TEventRecord> = (args: IEventPayload<TEventRecord, TEventName>) => void;
/**
...
export default class EventEmitter<T> implements IEventEmitter<T> {
     ...
     */
    addEventListener<TEventName extends keyof T>(evt: TEventName, fn: IListener<T, TEventName>, cancellationSignal?: CancellationSignal): void;
    /**
     ...
     */
    protected trigger<TEventName extends keyof T>(evt: TEventName, arg: IEventPayload<T, TEventName>): void;
}
