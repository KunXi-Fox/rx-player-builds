 ...
 * @returns {Promise}
 */
export default function removeBufferAroundTime(videoElement, sourceBufferInterface, time, margin) {
    ...
    if ((time + removalMargin) < videoElement.duration) {
        bufferRemovals.push(sourceBufferInterface.remove(time + removalMargin, videoElement.duration));
    }
