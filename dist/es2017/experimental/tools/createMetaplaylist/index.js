...
function createMetaplaylist(contentsInfos, timeOffset) {
    const playlistStartTime = timeOffset !== null && timeOffset !== void 0 ? timeOffset : 0;
    ...
    return Promise.all(completeContentsInfoProms).then((completeContentsInfos) => {
        const contents = completeContentsInfos
            ...
            const startTime = (_a = lastElement === null || lastElement === void 0 ? void 0 : lastElement.endTime) !== null && _a !== void 0 ? _a : playlistStartTime;
