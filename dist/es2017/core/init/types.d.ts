 ...
 */
import { IPeriodsUpdateResult, IAdaptationMetadata, IManifestMetadata, IPeriodMetadata, IRepresentationMetadata, IDecipherabilityStatusChangedElement } from "../../manifest";
...
import { IPublicNonFiniteStreamEvent, IPublicStreamEvent } from "./utils/stream_events_emitter";
/**
 ...
 */
export declare abstract class ContentInitializer extends EventEmitter<IContentInitializerEvents> {
    /**
     ...
     * intervals.
     */
    abstract start(mediaElement: HTMLMediaElement, playbackObserver: PlaybackObserver): void;
    /**
     ...
     */
    abstract updateContentUrls(urls: string[] | undefined, refreshNow: boolean): void;
    /**
