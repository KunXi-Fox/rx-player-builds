import { isCodecSupported, shouldReloadMediaSourceOnDecipherabilityUpdate, } from "../../../../compat";
...
export default class MultiThreadContentInitializer extends ContentInitializer {
    ...
    prepare() {
        ...
        sendMessage(worker, { type: "prepare" /* MainThreadMessageType.PrepareContent */,
            value: { contentId,
        ...
        this._initCanceller.signal.register(() => {
            sendMessage(worker, { type: "stop" /* MainThreadMessageType.StopContent */,
                contentId,
                value: null });
        });
        ...
        limitVideoResolution.onUpdate(newVal => {
            sendMessage(worker, { type: "ref-update" /* MainThreadMessageType.ReferenceUpdate */,
    ...
    updateContentUrls(urls, refreshNow) {
        ...
        sendMessage(this._settings.worker, { type: "urls-update" /* MainThreadMessageType.ContentUrlsUpdate */,
    ...
    start(mediaElement, playbackObserver) {
        ...
        const drmInitializationStatus = this._initializeContentDecryption(mediaElement, lastContentProtection, mediaSourceStatus, this._initCanceller.signal);
        ...
        const onmessage = (msg) => {
            ...
            switch (msgData.type) {
                ...
                case "add-source-buffer" /* WorkerMessageType.AddSourceBuffer */:
                    {
                        if (((_e = (_d = this._currentContentInfo) === null || _d === void 0 ? void 0 : _d.mainThreadMediaSource) === null || _e === void 0 ? void 0 : _e.id) !== msgData.mediaSourceId) {
                            return;
                        }
                ...
                case "source-buffer-append" /* WorkerMessageType.SourceBufferAppend */:
                    {
                        if (((_g = (_f = this._currentContentInfo) === null || _f === void 0 ? void 0 : _f.mainThreadMediaSource) === null || _g === void 0 ? void 0 : _g.id) !== msgData.mediaSourceId) {
                            return;
                        }
                        const mediaSource = this._currentContentInfo.mainThreadMediaSource;
                ...
                case "source-buffer-remove" /* WorkerMessageType.SourceBufferRemove */:
                    {
                        if (((_j = (_h = this._currentContentInfo) === null || _h === void 0 ? void 0 : _h.mainThreadMediaSource) === null || _j === void 0 ? void 0 : _j.id) !== msgData.mediaSourceId) {
                            return;
                        }
                        const mediaSource = this._currentContentInfo.mainThreadMediaSource;
                        const sourceBuffer = arrayFind(mediaSource.sourceBuffers, (s) => s.type === msgData.sourceBufferType);
                ...
                case "abort-source-buffer" /* WorkerMessageType.AbortSourceBuffer */:
                    {
                        if (((_l = (_k = this._currentContentInfo) === null || _k === void 0 ? void 0 : _k.mainThreadMediaSource) === null || _l === void 0 ? void 0 : _l.id) !== msgData.mediaSourceId) {
                            return;
                        }
                        const mediaSource = this._currentContentInfo.mainThreadMediaSource;
                        const sourceBuffer = arrayFind(mediaSource.sourceBuffers, (s) => s.type === msgData.sourceBufferType);
                ...
                case "update-media-source-duration" /* WorkerMessageType.UpdateMediaSourceDuration */:
                    {
                        if (((_o = (_m = this._currentContentInfo) === null || _m === void 0 ? void 0 : _m.mainThreadMediaSource) === null || _o === void 0 ? void 0 : _o.id) !== msgData.mediaSourceId) {
                            return;
                        }
                        const mediaSource = this._currentContentInfo.mainThreadMediaSource;
                ...
                case "stop-media-source-duration" /* WorkerMessageType.InterruptMediaSourceDurationUpdate */:
                    {
                        if (((_q = (_p = this._currentContentInfo) === null || _p === void 0 ? void 0 : _p.mainThreadMediaSource) === null || _q === void 0 ? void 0 : _q.id) !== msgData.mediaSourceId) {
                            return;
                        }
                        const mediaSource = this._currentContentInfo.mainThreadMediaSource;
                        if ((mediaSource === null || mediaSource === void 0 ? void 0 : mediaSource.id) !== msgData.mediaSourceId) {
                ...
                case "end-of-stream" /* WorkerMessageType.EndOfStream */:
                    {
                        if (((_s = (_r = this._currentContentInfo) === null || _r === void 0 ? void 0 : _r.mainThreadMediaSource) === null || _s === void 0 ? void 0 : _s.id) !== msgData.mediaSourceId) {
                            return;
                        }
                ...
                case "stop-end-of-stream" /* WorkerMessageType.InterruptEndOfStream */:
                    {
                        if (((_u = (_t = this._currentContentInfo) === null || _t === void 0 ? void 0 : _t.mainThreadMediaSource) === null || _u === void 0 ? void 0 : _u.id) !== msgData.mediaSourceId) {
                            return;
                        }
                ...
                case "dispose-media-source" /* WorkerMessageType.DisposeMediaSource */:
                    {
                        if (((_w = (_v = this._currentContentInfo) === null || _v === void 0 ? void 0 : _v.mainThreadMediaSource) === null || _w === void 0 ? void 0 : _w.id) !== msgData.mediaSourceId) {
                            return;
                        }
                ...
                case "manifest-ready" /* WorkerMessageType.ManifestReady */: {
                    ...
                    try {
                        ...
                        if (codecUpdate.length > 0) {
                            sendMessage(this._settings.worker, { type: "codec-support-update" /* MainThreadMessageType.CodecSupportUpdate */,
                                value: codecUpdate });
                        }
                    }
                    catch (err) {
                ...
                case "locked-stream" /* WorkerMessageType.LockedStream */: {
                    ...
                    (_16 = this._currentContentInfo
                        .rebufferingController) === null || _16 === void 0 ? void 0 : _16.onLockedStream(msgData.value.bufferType, period);
                    break;
                }
                ...
                case "reloading-media-source" /* WorkerMessageType.ReloadingMediaSource */:
                    {
                        ...
                        const isPaused = ((_26 = contentInfo.initialPlayPerformed) === null || _26 === void 0 ? void 0 : _26.getValue()) === true ||
                ...
                case "needs-decipherability-flush" /* WorkerMessageType.NeedsDecipherabilityFlush */:
                    {
                        ...
                        if (shouldReloadMediaSourceOnDecipherabilityUpdate(keySystem === null || keySystem === void 0 ? void 0 : keySystem[0])) {
                            const isPaused = ((_28 = contentInfo.initialPlayPerformed) === null || _28 === void 0 ? void 0 : _28.getValue()) === true ||
                                contentInfo.autoPlay === undefined ?
                                lastObservation.paused :
                                !contentInfo.autoPlay;
                            this._reload(mediaElement, textDisplayer, playbackObserver, mediaSourceStatus, currentPosition, !isPaused);
                        }
                        else {
    ...
    _initializeContentDecryption(mediaElement, lastContentProtection, mediaSourceStatus, cancelSignal) {
    ...
    _hasTextBufferFeature() {
        return (this._settings.textTrackOptions.textTrackMode === "html" &&
            features.htmlTextDisplayer !== null) || features.nativeTextDisplayer !== null;
    }
    ...
    _setUpModulesOnNewMediaSource(parameters, cancelSignal) {
        ...
        const corePlaybackObserver = createCorePlaybackObserver(playbackObserver, { autoPlay,
            initialPlayPerformed,
            manifest,
            mediaSource,
            speed,
            textDisplayer }, cancelSignal);
        if (cancelSignal.isCancelled()) {
            return null;
        }
        /**
    ...
    _startPlaybackIfReady(parameters) {
        ...
        sendMessage(this._settings.worker, { type: "start" /* MainThreadMessageType.StartPreparedContent */,
            contentId,
            value: { initialTime,
