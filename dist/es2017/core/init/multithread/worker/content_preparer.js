...
export default class ContentPreparer {
    ...
    initializeNewContent(context) {
        return new Promise((res, rej) => {
            ...
            const [mediaSource, segmentBuffersStore, workerTextSender,] = createMediaSourceAndBuffersStore(contentId, {
            ...
            function checkIfReadyAndValidate() {
                ...
                manifest.addEventListener("manifestUpdate", (updates) => {
                    ...
                    // clone.
                    const snapshot = objectAssign(manifest.getMetadataSnapshot(), { periods: [] });
                    sendMessage({
    ...
    reloadMediaSource(reloadInfo) {
        ...
        const [mediaSource, segmentBuffersStore, workerTextSender,] = createMediaSourceAndBuffersStore(this._currentContent.contentId, {
            hasMseInWorker: this._hasMseInWorker,
            hasVideo: this._hasVideo,
