...
import MainThreadTextInterface from "./utils/main_thread_text_displayer_interface";
...
export default class MediaSourceContentInitializer extends ContentInitializer {
    ...
    _startBufferingOnMediaSource(args, onReloadOrder, cancelSignal) {
        ...
        const segmentBuffersStore = new SegmentBuffersStore(mediaSource, mediaElement.nodeName === "VIDEO", textDisplayerInterface);
        cancelSignal.register(() => {
        ...
        const coreObserver = createCorePlaybackObserver(playbackObserver, { autoPlay,
            manifest,
            mediaSource,
            textDisplayer,
        ...
        const decipherabilityFreezeDetector = new DecipherabilityFreezeDetector(segmentBuffersStore);
        ...
        const contentTimeBoundariesObserver = createContentTimeBoundariesObserver(manifest, mediaSource, coreObserver, segmentBuffersStore, {
            onWarning: (err) => this.trigger("warning", err),
        ...
        const self = this;
        StreamOrchestrator({ manifest, initialPeriod }, coreObserver, representationEstimator, segmentBuffersStore, segmentFetcherCreator, bufferOptions, handleStreamOrchestratorCallbacks(), cancelSignal);
        /**
