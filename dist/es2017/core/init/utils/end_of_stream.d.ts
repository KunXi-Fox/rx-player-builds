 ...
 */
export default function triggerEndOfStream(mediaSource: MediaSource, cancelSignal: CancellationSignal): void;
/**
 ...
 * @param {Object} cancelSignal
 */
export declare function maintainEndOfStream(mediaSource: MediaSource, cancelSignal: CancellationSignal): void;
