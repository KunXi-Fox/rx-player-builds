...
export default function createSegmentFetcher(bufferType, pipeline, cdnPrioritizer, lifecycleCallbacks, options) {
    ...
    return async function fetchSegment(content, fetcherCallbacks, cancellationSignal) {
        ...
        (_a = lifecycleCallbacks.onRequestBegin) === null || _a === void 0 ? void 0 : _a.call(lifecycleCallbacks, { requestTimestamp: getTimestamp(),
            id: requestId,
            content });
        cancellationSignal.register(onCancellation);
        try {
            const res = await scheduleRequestWithCdns(content.representation.cdnMetadata, cdnPrioritizer, callLoaderWithUrl, objectAssign({ onRetry }, options), cancellationSignal);
