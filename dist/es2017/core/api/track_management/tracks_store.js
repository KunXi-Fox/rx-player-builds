...
export default class TracksStore extends EventEmitter {
     ...
     * `null` if no Audio Representation should be locked.
     */
    _setAudioOrTextTrack({ bufferType, periodRef, trackId, switchingMode, reprsToLock, relativeResumingPosition, }) {
        var _a, _b;
        ...
        if (reprsToLock === null) {
            ...
            const repSwitchingMode = bufferType === "audio" ?
                this._defaultAudioTrackSwitchingMode :
                "direct";
            lockedRepresentations = new SharedReference({
...
function generatePeriodInfo(period, inManifest, isTrickModeTrackEnabled, defaultAudioTrackSwitchingMode) {
    ...
    const forcedSubtitles = ((_a = period.adaptations.text) !== null && _a !== void 0 ? _a : [])
    ...
    if (forcedSubtitles.length > 0) {
        ...
        if (textAdaptation === null) {
            textAdaptation = (_b = arrayFind(forcedSubtitles, (f) => f.normalizedLanguage === undefined)) !== null && _b !== void 0 ? _b : null;
        }
    }
