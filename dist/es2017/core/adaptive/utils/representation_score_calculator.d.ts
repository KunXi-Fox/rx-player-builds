...
export default class RepresentationScoreCalculator {
    ...
    private _lastRepresentationWithGoodScore;
    constructor();
    /**
     * Add new sample data.
     ...
     * seconds.
     */
    addSample(representation: Representation, requestDuration: number, segmentDuration: number): void;
    /**
     ...
     */
    getLastStableRepresentation(): Representation | null;
}
/**
 ...
 */
export declare const enum ScoreConfidenceLevel {
