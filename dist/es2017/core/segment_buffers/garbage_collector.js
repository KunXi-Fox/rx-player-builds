 ...
 */
export default function BufferGarbageCollector({ segmentBuffer, playbackObserver, maxBufferBehind, maxBufferAhead }, cancellationSignal) {
    let lastPosition;
    let lastBuffered = [];
 ...
 * @returns {Promise}
 */
async function clearBuffer(segmentBuffer, position, buffered, maxBufferBehind, maxBufferAhead, cancellationSignal) {
