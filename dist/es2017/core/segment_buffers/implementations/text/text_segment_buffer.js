...
export default class TextSegmentBuffer extends SegmentBuffer {
    ...
    declareInitSegment(uniqueId) {
        log.warn("HTSB: Declaring initialization segment for  Text SegmentBuffer", uniqueId);
    }
    /**
     * @param {string} uniqueId
     */
    freeInitSegment(uniqueId) {
        log.warn("HTSB: Freeing initialization segment for  Text SegmentBuffer", uniqueId);
    }
    /**
