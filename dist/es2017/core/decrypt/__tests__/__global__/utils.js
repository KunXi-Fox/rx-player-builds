...
export class MediaKeySessionImpl extends EventEmitter {
    ...
    generateRequest(initDataType, initData) {
        ...
        setTimeout(() => {
            const event = Object.assign(new CustomEvent("message"), { message: msg.buffer,
...
export function mockCompat(exportedFunctions = {}) {
    ...
    const onEncrypted = (_a = exportedFunctions.onEncrypted) !== null && _a !== void 0 ? _a : jest.fn((elt, fn, signal) => {
    ...
    const mockRmksa = (_b = exportedFunctions.requestMediaKeySystemAccess) !== null && _b !== void 0 ? _b : jest.fn(requestMediaKeySystemAccessImpl);
    const mockSetMediaKeys = (_c = exportedFunctions.setMediaKeys) !== null && _c !== void 0 ? _c : jest.fn(() => Promise.resolve());
    ...
    jest.mock("../../../../compat", () => (Object.assign({ events: mockEvents, shouldRenewMediaKeySystemAccess: jest.fn(() => false), shouldWaitForEncryptedBeforeAttachment: jest.fn(() => false), canReuseMediaKeys: jest.fn(() => true) }, exportedFunctions)));
    const emeImplementation = {
        onEncrypted,
        requestMediaKeySystemAccess: mockRmksa,
        setMediaKeys: mockSetMediaKeys,
    };
    jest.mock("../../../../compat/eme", () => (Object.assign({ __esModule: true, default: emeImplementation, getInitData: mockGetInitData, generateKeyRequest: mockGenerateKeyRequest }, exportedFunctions)));
    return { mockEvents,
        eventTriggers: {
            triggerEncrypted(elt, value) {
