 ...
 * doing.
 */
export default function RepresentationStream({ content, options, playbackObserver, segmentBuffer, segmentFetcher, terminate }, callbacks, parentCancelSignal) {
    ...
    const lastSegmentQueue = new SharedReference({
        initSegment: null,
        segmentQueue: [],
        ...
        if (evt.segmentType === "init") {
            ...
            if (evt.initializationData !== null) {
                ...
                pushInitSegment({ playbackObserver,
                    ...
                    segmentBuffer }, globalCanceller.signal)
                    .then((result) => {
                    if (result !== null) {
