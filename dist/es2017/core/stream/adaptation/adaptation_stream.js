 ...
 * doing.
 */
export default function AdaptationStream({ playbackObserver, content, options, representationEstimator, segmentBuffer, segmentFetcherCreator, wantedBufferAhead, maxVideoBufferSize }, callbacks, parentCancelSignal) {
    ...
    const initialRepresentations = content.adaptation.representations.filter(r => arrayIncludes(initialRepIds, r.id) &&
    ...
    content.representations.onUpdate((val) => {
        ...
        const newRepresentations = content.adaptation.representations.filter(r => arrayIncludes(newRepIds, r.id));
    ...
    async function onRepresentationsChoiceChange(choice, fnCancelSignal) {
        ...
        // in the buffer
        const switchStrat = getRepresentationsSwitchingStrategy(period, adaptation, choice, segmentBuffer, playbackObserver);
    ...
    function createRepresentationStream(representation, terminateCurrentStream, representationStreamCallbacks, fnCancelSignal) {
        ...
        RepresentationStream({ playbackObserver,
            ...
            options: { bufferGoal,
                ...
                fastSwitchThreshold } }, updatedCallbacks, fnCancelSignal);
