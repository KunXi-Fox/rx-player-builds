 ...
 * @returns {Object} - `SegmentBuffer` implementation.
 */
export type INativeTextTracksBuffer = new (mediaElement: HTMLMediaElement) => SegmentBuffer;
 ...
 */
export type IDebugElementFn = (parentElt: HTMLElement, instance: RxPlayer, cancelSignal: CancellationSignal) => void;
/**
